...
// except getCssSelectorOF and getPathTo handmade customizations
(function() {
    var SWD_Page_Recorder, addStyle, bye, createCommand, dbg, getInputElementsByTypeAndValue, getPageXY, getCssSelectorOF, getPathTo, handler, hello, prev, preventEvent, pseudoGuid, rightClickHandler, say;
    ...
    rightClickHandler = function(event) {
        var JsonData, body, eventPreventingResult, mxy, path, root, target, txy, xpath, css_selector;
        ...
        if (event.ctrlKey) {
            ...
            document.SWD_Page_Recorder.showPos(event, xpath,css_selector);
    ...
    SWD_Page_Recorder = (function() {
        ...
        SWD_Page_Recorder.prototype.showPos = function(event, xpath, css_selector) {
            var x, y;
            hello("showPos");
            if (window.event) {
